...
- **BPM (session average)**  
  Bites per minute over the whole session:  
  $$
  \mathrm{BPM}
  \;=\;
  \frac{B}{T/60}
...
- **Rolling BPM (30s)**  
  ...
  $$
  \mathrm{rolling\_bpm}(t)
  \;=\;
  \frac{\#\{\,b_i \mid t-30 < b_i \le t\,\}}{30/60}
  \;=\;
  2 \cdot \#\{\,b_i \mid t-30 < b_i \le t\,\}.
  $$
...
- **% Intake (`intake_pct`)**  
  ...
  \;=\;
  100 \times
  \frac{\sum_{k=1}^{N}\mathrm{intake\_flag}_k}{N},
  $$
